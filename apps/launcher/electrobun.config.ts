...
export default {
  ...
  build: {
    ...
    views: {
      ...
      bosstimersview: { entrypoint: "src/views/boss-timers/index.tsx" },
    ...
    copy: {
      ...
      "src/views/boss-timers/index.html": "views/bosstimersview/index.html",
      "src/views/boss-timers/index.css": "views/bosstimersview/index.css",
      [themeCssSource(5)]: "views/bosstimersview/theme.css",
