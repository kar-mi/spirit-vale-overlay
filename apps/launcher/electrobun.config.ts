...
export default {
  ...
  build: {
    ...
    views: {
      launcherview: { entrypoint: "src/launcherview/index.tsx" },
      settingsview: { entrypoint: "src/settingsview/index.tsx" },
      ...
      characterview: { entrypoint: "src/characterview/index.tsx" },
      marketview: { entrypoint: "../../packages/market/src/marketview/index.tsx" },
      marketfiltersview: { entrypoint: "../../packages/market/src/marketfiltersview/index.tsx" },
    ...
    copy: {
      ...
      "../../packages/market/src/marketview/index.html": "views/marketview/index.html",
      "../../packages/market/src/marketview/index.css": "views/marketview/index.css",
      [themeCssSource(5)]: "views/marketview/theme.css",
      "../../packages/market/src/marketfiltersview/index.html": "views/marketfiltersview/index.html",
      "../../packages/market/src/marketfiltersview/index.css": "views/marketfiltersview/index.css",
    ...
    targets: "win-x64",
    watch: ["src", "../../packages/build-export/src", "../../packages/combat/src", "../../packages/market/src", "../../packages/overlay/src", "../../packages/rewards/src", "../../packages/ui-kit"],
    win: {
      bundleCEF: false,
