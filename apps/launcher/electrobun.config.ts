...
export default {
  ...
  build: {
    ...
    views: {
      ...
      minimapview: { entrypoint: "../../packages/overlay/src/minimapview/index.tsx" },
    ...
    copy: {
      ...
      "../../packages/overlay/src/minimapview/index.html": "views/minimapview/index.html",
      "../../packages/overlay/src/minimapview/index.css": "views/minimapview/index.css",
      [themeCssSource(16)]: "views/minimapview/theme.css",
